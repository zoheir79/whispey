...
CREATE INDEX IF NOT EXISTS idx_billing_invoices_workspace_id ON billing_invoices(workspace_id);
...
CREATE INDEX IF NOT EXISTS idx_billing_items_agent_id ON billing_items(agent_id);
CREATE INDEX IF NOT EXISTS idx_billing_items_platform_mode ON billing_items(platform_mode);
