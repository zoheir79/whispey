  ...
  try {
    ...
    let sql = `
      SELECT 
        ...
        SUM(COALESCE((cl.transcription_metrics->>'input_tokens')::integer, 0)) as llm_tokens_input,
        SUM(COALESCE((cl.transcription_metrics->>'output_tokens')::integer, 0)) as llm_tokens_output,
