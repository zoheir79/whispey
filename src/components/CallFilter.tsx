    ...
    <div className="w-fit">
      ...
      <div className="flex items-center gap-2">
        <Popover open={isOpen} onOpenChange={setIsOpen}>
          ...
          <PopoverContent className="w-[600px] p-3 bg-white dark:bg-slate-800 border-gray-200 dark:border-slate-700" align="start">
            <div className="space-y-3">
              ...
              <div className={`grid gap-2 ${gridCols}`}>
                ...
                <DropdownMenuTrigger asChild>
                  ...
                  <DropdownMenuContent align="start" className="w-48 bg-white dark:bg-slate-800 border-gray-200 dark:border-slate-700">
                    {COLUMNS.map((column) => (
                      <DropdownMenuItem
                        key={column.value}
                        onClick={() => {
                        ...
                        className="text-xs text-gray-900 dark:text-gray-100 hover:bg-gray-100 dark:hover:bg-slate-700"
                      >
                        {column.label}
                      </DropdownMenuItem>
                    ))}
                ...
                {isJsonbColumn() && (
                  <DropdownMenu>
                    ...
                    <DropdownMenuContent align="start" className="w-40 max-h-48 overflow-y-auto bg-white dark:bg-slate-800 border-gray-200 dark:border-slate-700">
                ...
                <DropdownMenuTrigger asChild>
                  ...
                  <DropdownMenuContent align="start" className="w-40 bg-white dark:bg-slate-800 border-gray-200 dark:border-slate-700">
                  ...
                  <>
                    {isDateField ? (
                      ...
                      <PopoverTrigger asChild>
                        ...
                        <PopoverContent className="w-auto p-0 bg-white dark:bg-slate-800 border-gray-200 dark:border-slate-700" align="start" side="bottom">
                          <Calendar
                            mode="single"
